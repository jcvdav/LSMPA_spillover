...
# Main targets
data/processed/distance_grid.rds: scripts/02_make_data/01_build_distance_grid.R data/processed/clean_lmpas.gpkg data/processed/quarterly_all_rfmos.rds
		cd $(<D);Rscript $(<F)

## CLEANING RFMO DATA ##########################################################
# Combine into one
data/processed/quarterly_all_rfmos.rds: scripts/02_make_data/02_make_quarterly_all_rfmos.R data/processed/wcpfc_tuna_quarterly_gear_flag.rds data/processed/iattc_tuna_monthly_gear_flag.rds data/processed/iotc_tuna_monthly_gear_flag.rds data/processed/iccat_tuna_monthly_gear_flag.rds
		cd $(<D);Rscript $(<F)

data/processed/annual_all_rfmos.rds: scripts/02_make_data/03_make_annual_all_rfmos.R data/processed/wcpfc_tuna_quarterly_gear_flag.rds data/processed/iattc_tuna_monthly_gear_flag.rds data/processed/iotc_tuna_monthly_gear_flag.rds data/processed/iccat_tuna_monthly_gear_flag.rds
		cd $(<D);Rscript $(<F)
