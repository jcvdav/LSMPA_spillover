...
\toprule
\multicolumn{1}{c}{ } & \multicolumn{4}{c}{Gears combined} & \multicolumn{1}{c}{Purse Seine} & \multicolumn{1}{c}{Longline} \\
\cmidrule(l{3pt}r{3pt}){2-5} \cmidrule(l{3pt}r{3pt}){6-6} \cmidrule(l{3pt}r{3pt}){7-7}
  & (1) & (2) & (3) & (4) & (5) & (6)\\
\midrule
\addlinespace[0.3em]
