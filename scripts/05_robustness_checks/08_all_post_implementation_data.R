...
# Load data --------------------------------------------------------------------
annual_panel_full_post <- readRDS(file = here("data", "processed", "annual_full_estimation_panel_full_post.rds"))
...
# Combine model objects into exportable lists
main_reg_full_post <- list(step1,
                           step2,
                           step3,
                           step4,
                           step5)

relevant_mpa_gear_reg_full_post <- list(step1_r,
                                        step2_r,
                                        step3_r,
                                        step4_r,
                                        step5_r)

## BUILD REGRESSION TABLE FOR SUPPLEMENTS ######################################
...
panelsummary(main_reg_full_post,
             relevant_mpa_gear_reg_full_post,
             stars = "econ",
  ...
  cat(file = here("results", "tab", "tabS_full_post_reg_table.tex"))
...
# Export models ----------------------------------------------------------------
# Main models
saveRDS(object = main_reg_full_post,
        file = here("data", "output", "main_reg_full_post.rds"))

# Relevant MPA-gear combinations
saveRDS(object = relevant_mpa_gear_reg_full_post,
        file = here("data", "output", "relevant_mpa_gear_reg_full_post.rds"))
